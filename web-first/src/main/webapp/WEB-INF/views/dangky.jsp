...
<body id="background-login">
		...
		<div class="container-login">
			...
			<div class="container-login-right">
				<div id="header-top-right" class="header-login"
					...
					<span   id="dangnhap">Đăng nhập</span>/<span
								 class="actived" id="dangky">Đăng ký</span>
	...
	<id class="container-login-form" id="container-center-right-login">
					...
					<input id ="nhaplaimatkhau" name ="nhapLaiMatKhau" class="mate-textinput-inputicon-password" type="text" placeholder="ENTER THE PASSWORD" ></br>
					<input id="btdangky" class="mate-button" type="submit"
						value="ĐĂNG KÝ"> </br>
					</id>
